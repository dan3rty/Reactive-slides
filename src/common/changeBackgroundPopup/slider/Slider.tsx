...
function useDraggableSliderDot({elementRef, parentRef, onSliderChange}: useDraggableSliderDotProps) {
    let sliderWidth = 0
    ...
    function moving(e: MouseEvent) {
        ...
        let offset = dx < 0 ? '0%' : dx > sliderWidth ? '100%' : `${dx / sliderWidth * 100}%`
...
function Slider(props: SliderProps) {
    ...
    const dotPosition = useDraggableSliderDot({elementRef: sliderDotRef, parentRef: sliderRef, onSliderChange: props.onSliderChange})
    return (
