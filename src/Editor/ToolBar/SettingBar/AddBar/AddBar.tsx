...
function AddBar() {
	...
	return (
		<div className={styles.addBar}>
			...
			<Button style='light' size='big' icon={BulletListIcon} text='bullet list' onClick={log} />
			...
			<Button style='light' size='big' icon={NumberedListIcon} text='numbered list' onClick={log} />
